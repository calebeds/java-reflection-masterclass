...
import static annotations.bestgamesfinder.annotationsbestgame.Annotations.*;
import annotations.bestgamesfinder.databases.Database;
...
public class BestGamesFinder {
    ...
    public SortedMap<Double, String> scoreGames(@DependsOn("Game-To-Price") Map<String, Float> gameToPrice,
        ...
        for(String gameName: gameToPrice.keySet()) {
            double score = gameToRating.get(gameName) /  gameToPrice.get(gameName);
