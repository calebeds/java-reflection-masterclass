package arrays.jsonserializerwitharrays.jsonwriter;

import arrays.jsonserializerwitharrays.data.Actor;
import arrays.jsonserializerwitharrays.data.Movie;
...
public class JsonWriter {
    public static void main(String[] args) throws IllegalAccessException {
        ...
        String json = objectToJson(lordOfTheRings, 0);
